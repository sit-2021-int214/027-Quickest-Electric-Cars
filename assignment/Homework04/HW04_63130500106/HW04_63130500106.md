...
```
**Explain**
การจัดอันดับยอดรวมราคาสั่งซื้อของแต่ละภูมิภาค มีดังนี้
...
```
**Explain**
- Clytie Kelty เป็นลูกค้าที่มีการสั่งซื้อสินค้าแบบ First Class บ่อยที่สุด (จำนวน 14 ครั้ง)
-------
...
```
**Explain**
จัดอันดับหมวดหมู่สินค้าย่อยที่มียอดการสั่งซื้อบ่อยครั้งมากที่สุด 5 อันดับ มีดังนี้
- อันดับ 1 : Binder
- อันดับ 2 : Paper
...
```
**Explain**
- ปี 2015 มียอดขายรวมทั้งหมด 479,856
- ปี 2016 มียอดขายรวมทั้งหมด 459,436
- ปี 2017 มียอดขายรวมทั้งหมด 600,193
- ปี 2018 มียอดขายรวมทั้งหมด 722,052
-------
